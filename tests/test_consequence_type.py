...
class ProcessConsequenceTypeFileTsvTest(unittest.TestCase):
    def test__process_consequence_type_file_tsv(self):
        test_consequence_type = consequence_type.ConsequenceType(ensembl_gene_ids=["ENSG00000083093"],
        ...
        consequence_type_dict, one_rs_multiple_genes = \
            consequence_type.process_consequence_type_file_tsv(snp_2_gene_xls)
