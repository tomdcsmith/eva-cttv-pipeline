...
class ProcessGeneTest(unittest.TestCase):
    def test__process_gene(self):
        ...
        test_consequence_type = consequence_type.ConsequenceType(test_ensembl_gene_id, test_so_name)
...
class ProcessConsequenceTypeFileTsvTest(unittest.TestCase):
    def test__process_consequence_type_file_tsv(self):
        test_consequence_type = consequence_type.ConsequenceType("ENSG00000021488", "missense_variant")
